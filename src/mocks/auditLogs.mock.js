export const mockAuditLogs = [
  {
    ...
    employeeId: 'e1',
    action: 'CREATED',
    changedBy: { id: 'u1', firstName: 'Admin', lastName: 'User', email: 'admin@company.com' },
    changeReason: 'Initial employee creation',
    createdAt: '2020-01-10T10:00:00Z',
    changes: [
      { fieldName: 'first_name', oldValue: null, newValue: 'John' },
      { fieldName: 'last_name', oldValue: null, newValue: 'Doe' },
  ...
  },
  {
    ...
    employeeId: 'e3',
    action: 'DELETED',
    changedBy: { id: 'u2', firstName: 'HR', lastName: 'Manager', email: 'hr@company.com' },
